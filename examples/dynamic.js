...
function (_React$Component) {
  ...
  function App() {
    ...
    _defineProperty(_assertThisInitialized(_this), "addStep", function () {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      }, "Add new step"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(rc_steps__WEBPACK_IMPORTED_MODULE_4___default.a, null, steps.map(function (step, i) {
...
react_dom__WEBPACK_IMPORTED_MODULE_3___default.a.render(react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(App, null), document.getElementById('__react-content'));
